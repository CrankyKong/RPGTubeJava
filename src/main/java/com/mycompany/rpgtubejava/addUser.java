...
public class addUser extends HttpServlet {
	...
	String name = request.getParameter("user");
        ...
        try {
            ...
            sessionHandler.putStringVar("username", name);
            // session for avatar_id
            sessionHandler.putStringVar("avatarId", avatarIdS);
            // session for user_id 
            sessionHandler.putStringVar("userId", userIdS);
            // session for inv_id
            sessionHandler.putStringVar("invId", invIdS);

            sessionHandler.logIn(name, password);
        ...
        request.getRequestDispatcher("EntryPoint").forward(request, response);
    }
